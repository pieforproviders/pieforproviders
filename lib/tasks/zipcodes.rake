...
# Taken and optimized from my_zipcode_gem rake file.
#
namespace :zipcodes_gem do
  ...
  task import: :environment do
    ...
    Rake::Task['zipcodes_gem:import_cities_and_zipcodes'].invoke
  end
  ...
  def check_for_existing(klass, args)
    unless klass.none? || (args[:append] == true.to_s)
      raise "#{klass} already exist. If you want to import and add more, run this with [true]"
    end
  end
