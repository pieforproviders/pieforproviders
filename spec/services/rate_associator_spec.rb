...
#   let!(:rate_cook_age5) { create(:rate_for_illinois, max_age: 5) }
#   let!(:rate_cook_age3) { create(:rate_for_illinois, max_age: 3) }
#   let!(:rate_dupage) { create(:rate_for_illinois, county: 'DuPage', max_age: 12) }
...
#       child_cook.save!
#     end
#     expect(child_cook.active_rate(date)).to eq(rate_cook_age3)
#   end
...
#     end
#     expect(child_cook.active_rate(date)).to eq(rate_cook_age5)
...
#     end
#     expect(child_cook.active_rate(date)).to eq(rate_dupage)
#   end
# end
